...
_react2['default'].render(_react2['default'].createElement(_componentsImageGrid2['default'], null), document.getElementById('content'));
...
var ImageStore = _reflux2['default'].createStore({
  ...
  fetchList: function fetchList() {
    var tags = ['web', 'animation', 'cars', 'sports', 'react'];
    var randomTag = tags[Math.floor(Math.random() * tags.length)];
    _jquery2['default'].ajax({
      url: this.url + '&tag=cars',
      dataType: 'jsonp',
